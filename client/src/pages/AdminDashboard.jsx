                ...
                <td className="px-6 py-4">
                  <div className="flex flex-wrap gap-1">
                    {q.tags && q.tags.length > 0 ? (
                      q.tags.map((tag, i) => (
                        <span key={i} className="bg-blue-600/50 text-blue-100 px-2 py-0.5 rounded-full text-xs">
                          {tag}
                        </span>
                      ))
                    ) : (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="mt-4">
                  ...
                  <div className="flex flex-wrap gap-2 mb-2">
                    {form.tags.map((tag, i) => (
                      <div key={i} className="bg-blue-600 text-white px-2 py-1 rounded-full text-sm flex items-center gap-1">
                        {tag}
                        <button
                          type="button"
                          onClick={() => {
                  ...
                  <div className="flex gap-2">
                    <input
                      type="text"
                      placeholder="Add tag (e.g. 'arrays', 'dp', 'strings')"
                      className="flex-grow p-2 rounded bg-[#31304D] text-white"
                      onKeyPress={(e) => {
