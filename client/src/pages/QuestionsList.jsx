...
const Tabs = ["Practice Questions", "My Submissions", "AI Insight"];
...
const QuestionsList = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${import.meta.env.VITE_BACKEND_URL}/api/problems/tags`)
      .then((res) => {
        if (res.data.success) {
  ...
  // Fetch questions whenever selected tags change
  useEffect(() => {
    // Fetch questions with tag filters if any are selected
    const fetchQuestions = () => {
      const url = selectedTags.length > 0
        ? `${import.meta.env.VITE_BACKEND_URL}/api/questions?tags=${selectedTags.join(',')}`
  ...
  return (
    <div className="bg-[#161A30] min-h-screen text-white p-6">
      <h1 className="text-4xl font-extrabold mb-6 text-center">AlgoJudgeX</h1>
      ...
      {activeTab === 0 && (
        <>
          {/* Tag filters */}
          <div className="mb-6 bg-[#1E1E2E] p-4 rounded-lg">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {selectedTags.length > 0 && (
                <button
                  ...
                  className="px-3 py-1 rounded-full text-sm bg-red-600 text-white hover:bg-red-700 transition-all"
                >
                  Clear Filters
                </button>
              )}
                  ...
                  <div className="bg-gradient-to-br from-[#1e1e2e]/80 to-[#2c2f4a]/50 backdrop-blur-sm rounded-2xl shadow-2xl border border-gray-700/30 p-8 max-w-md mx-auto">
                    <div className="text-center space-y-6">
                      ...
                      <div className="space-y-2">
                        <h3 className="text-2xl font-bold text-white">No submissions to display</h3>
                        <p className="text-gray-400">
                          Please log in to view your submissions or start coding.
                        </p>
                      </div>
                      ...
                      <div className="pt-4 border-t border-gray-700/50">
                        <p className="text-xs text-gray-500">
                          Join <span className="text-[#00FFC6] font-semibold">AlgoJudgeX</span> to track your progress
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            {submissions.length === 0 ? (
              <div className="text-center text-gray-400 py-16 flex flex-col items-center justify-center space-y-4">
                {user ? (
                  ...
                  <div className="bg-gradient-to-br from-[#1e1e2e]/80 to-[#2c2f4a]/50 backdrop-blur-sm rounded-2xl shadow-2xl border border-gray-700/30 p-6">
                    <div className="text-center space-y-4">
                      ...
                      <div className="space-y-1">
                        <h3 className="text-lg font-bold text-white">No submissions to display</h3>
                      ...
                      <Link
                        to="/auth"
                        className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#00FFC6] to-[#4ecdc4] text-black font-semibold rounded-lg hover:shadow-lg hover:shadow-[#00FFC6]/25 transition-all duration-300 text-sm"
                      >
                      ...
                      <div className="pt-3 border-t border-gray-700/50">
                        <p className="text-xs text-gray-500">
                          Join <span className="text-[#00FFC6] font-semibold">AlgoJudgeX</span>
                        </p>
                      </div>
                    </div>
                  </div>
